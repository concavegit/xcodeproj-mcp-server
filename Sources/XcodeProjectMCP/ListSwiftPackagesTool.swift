...
public struct ListSwiftPackagesTool: Sendable {
  ...
  public func execute(arguments: [String: Value]) throws -> CallTool.Result {
    ...
    do {
      ...
      for remotePackage in project.remotePackages {
        let requirement = formatVersionRequirement(remotePackage.versionRequirement ?? .exact("unknown"))
  ...
  private func formatVersionRequirement(_ requirement: XCRemoteSwiftPackageReference.VersionRequirement)
    -> String
  {
    switch requirement {
